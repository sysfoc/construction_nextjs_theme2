    ...
    <section className="relative w-full h-[420px] flex items-center justify-center overflow-hidden">
      ...
      {testimonials.length > 0 && (
        <div className="relative z-10 w-full max-w-5xl mx-auto px-4 py-8 sm:py-10">
          <div className="bg-[var(--color-background)]/75 backdrop-blur-md rounded-2xl shadow-lg border border-[var(--color-border)] overflow-hidden h-[340px] flex flex-col">
            {/* Testimonial Card */}
            <div className="p-6 md:p-4 flex-1 overflow-y-auto">
              <div className="mb-2">
