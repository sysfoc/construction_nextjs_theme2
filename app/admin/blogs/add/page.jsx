...
export default function AddBlog() {
  const [formData, setFormData] = useState({
    ...
    metaTitle: "",
    metaDescription: "",
    blogWriter: "", // renamed from 'writer' to 'blogWriter' for consistency
  })
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          <Link href={"/admin/blogs"}>
            <Button size="md" className="bg-[#e56c16] hover:!bg-[#e56c16] text-white rounded-md">
              Go Back
            </Button>
          </Link>
        </div>
            ...
            <div className="flex flex-col gap-1 col-span-2">
              <div>
                ...
                <Suspense fallback={<p>Loading editor...</p>}>
                  <LazyJoditEditor value={formData.content} config={config} tabIndex={1} onBlur={handleContentChange} />
                </Suspense>
              </div>
            </div>
            <div className="flex flex-col gap-1 col-span-2">
